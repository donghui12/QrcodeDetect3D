...
from QrcodeDetect3D import utilities as ut
...
def detectQRCode(src):
	...
	# Find contours
	binary, contours, hierarchy = cv2.findContours(canny_img, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
	...
	if len(marker_candidate) < 3:
		print('Number of detected markers is less than 3')
		return None
	else:
	...
	if bot_right_corner is None:
		print('Bottom line and right line do not intersect')
		return None
